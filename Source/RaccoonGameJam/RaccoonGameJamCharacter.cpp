...
ARaccoonGameJamCharacter::ARaccoonGameJamCharacter()
{
...
void ARaccoonGameJamCharacter::BeginPlay()
{
	// Call the base class  
	Super::BeginPlay();
}
...
void ARaccoonGameJamCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		// Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &ARaccoonGameJamCharacter::Move);
...
void ARaccoonGameJamCharacter::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void ARaccoonGameJamCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
